 ...
 * 'Denim' template design by zen-cart-power.net
...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' J All Rights Reserved ');
...
define('HEADER_NEW_PRODUCTS', '');
define('HEADER_SPECIALS', 'Specials');
define('HEADER_FEATURED_PRODUCTS', 'Featured Products');
define('HEADER_MY_ACCOUNT', 'My Account'); 
define('HEADER_SHOPPING_CART_EMPTY', 'Your shopping cart is empty'); 
define('HEADER_PRODUCT_AMOUNT', 'Item(s)'); 
define('HEADER_SUBTOTAL', 'Subtotal');
define('HEADER_WELCOME', 'Welcome');
define('HEADER_ALT_TEXT', 'Template by Zen-Cart-Power.net - Power Your Zen Cart!');
