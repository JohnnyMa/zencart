...
<div class="centerBoxHeadingDetail">
	<div class="dhead"><span class="float-left"><?php echo HEADING_TITLE; ?></span>

	<div class="float-right"><?php echo TEXT_VISITORS_CART; ?></div>

	<div class="clearBoth"></div>
	</div>
</div>

<div class="centerColumn centerBoxWrapper" id="shoppingCartDefault">
<?php
...
<div id="cartSubTotal"><span><?php echo SUB_TITLE_SUB_TOTAL; ?> <?php echo $cartShowTotal; ?></span></div>
<br class="clearBoth" />
