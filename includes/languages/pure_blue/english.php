...
// javascript messages
  ...
  define('PREVNEXT_BUTTON_PREV', '&lsaquo;&nbsp;Prev');
  define('PREVNEXT_BUTTON_NEXT', 'Next&nbsp;&rsaquo;');
...
// misc
  ...
  define('HEADING_TITLE_PRODUCT_DETAILS', 'Product Details');

  define('COLUMNAR_PRICE', 'Price:');
